<section id="create-tool-modal" tabindex="-1" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black/10 backdrop-blur-sm transition-opacity duration-300">
    <div class="w-full max-w-2xl p-5 sm:p-6">
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <form action="{{ route('create.tool') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="2"
                        placeholder="Briefly describe this tool and its purpose..."
                ...
                <div>
                    ...
                    <input type="file" id="image" name="image" accept="image/*"
                        class="w-full p-2 text-sm text-gray-500
                            ...
                            hover:file:bg-green-100 focus:outline-none focus:ring-2 focus:ring-green-200"/>
                </div>
